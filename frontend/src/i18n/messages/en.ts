export const enMessages = {
  ...
  'service.description': 'View service endpoints, ports, and configuration.',
  'configmap.detail': 'ConfigMap Details',
  'configmap.description': 'Manage ConfigMap and Secret data.',
