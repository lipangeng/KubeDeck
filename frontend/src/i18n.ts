...
const messages = {
  en: {
    ...
    oauthConfigMode: 'Mode: {{value}}',
    oauthConfigProvider: 'Provider: {{value}}',
    oauthConfigReady: 'Ready: {{value}}',
    oauthConfigMissingFields: 'Missing Fields: {{value}}',
    oauthConfigLoadError: 'OAuth config unavailable: {{error}}',
    logout: 'Logout',
    username: 'Username',
    password: 'Password',
    ...
    iamGroups: 'Groups',
    iamUsers: 'Users',
    iamTenantMembers: 'Tenant Members',
  ...
  zh: {
    ...
    oauthConfigMode: '模式：{{value}}',
    oauthConfigProvider: '提供方：{{value}}',
    oauthConfigReady: '就绪：{{value}}',
    oauthConfigMissingFields: '缺失字段：{{value}}',
    oauthConfigLoadError: 'OAuth 配置不可用：{{error}}',
    logout: '退出登录',
    username: '用户名',
    password: '密码',
    tenantCode: '租户编码',
    ...
    userId: '用户ID',
    addTenantMember: '添加成员',
    removeTenantMember: '移除成员',
