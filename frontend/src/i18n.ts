...
const messages = {
  en: {
    ...
    iamReadOnlyMode: 'Read-only mode: viewer role cannot modify IAM data.',
    ...
    inviteCreatedAt: 'created: {{value}}',
    inviteExpiresAt: 'expires: {{value}}',
  ...
  zh: {
    ...
    iamReadOnlyMode: '只读模式：viewer 角色不可修改 IAM 数据。',
    ...
    inviteCreatedAt: '创建时间：{{value}}',
    inviteExpiresAt: '过期时间：{{value}}',
