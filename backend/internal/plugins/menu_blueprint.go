...
func defaultMenuBlueprint() MenuBlueprint {
	return defaultMenuBlueprintForScope("")
}

func defaultMenuBlueprintForScope(scope string) MenuBlueprint {
	switch scope {
	case "system":
			...
			Groups: []MenuBlueprintGroup{
				{
					Key:   "config",
					Order: 10,
					Title: sdk.TextRef{Key: "menu.group.config", Fallback: "Configuration"},
				},
			},
