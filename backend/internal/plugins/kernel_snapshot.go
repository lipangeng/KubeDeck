...
type KernelSnapshot struct {
	...
	ResourcePageExtensions []sdk.ResourcePageExtensionDescriptor `json:"resourcePageExtensions"`
}
...
func ComposeScopedKernelSnapshotWithOverrides(
	...
	return KernelSnapshot{
		...
		ResourcePageExtensions: ComposeResourcePageExtensions(descriptors),
	}
}

func ComposeResourcePageExtensions(
	descriptors []sdk.CapabilityDescriptor,
) []sdk.ResourcePageExtensionDescriptor {
	extensions := make([]sdk.ResourcePageExtensionDescriptor, 0)
	for _, descriptor := range descriptors {
		extensions = append(extensions, descriptor.ResourcePageExtensions...)
	}
	return extensions
}
